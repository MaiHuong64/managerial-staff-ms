...
import {getAll, getByID, removeCandidate, addCandidate, addVoteResult, getPlanningSrc, createBatch, startVotingProcess, getCurrentStep} from "../controllers/appointmentController";
