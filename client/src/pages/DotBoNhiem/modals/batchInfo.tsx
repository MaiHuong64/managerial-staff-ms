...
export const BatchInfo: React.FC<Props> = ({user}) => {
    return (
        <Card size="small" title={<span><FileTextOutlined className="mr-2 text-blue-500" />Thông tin chung</span>}>
            <Form.Item label="Tên đợt bổ nhiệm" name="tenDotBoNhiem" rules={[{ required: true, message: "Vui lòng nhập tên đợt" }]}>
                <Input placeholder="VD: Đợt bổ nhiệm tháng 3/2026" />
            </Form.Item>
            <Form.Item label="Người lập">
                <Input value={user?.hoVaTen} disabled />
            </Form.Item>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                <Form.Item label="Ngày bắt đầu" name="ngayBatDau" rules={[{ required: true, message: "Chọn ngày" }]}>
