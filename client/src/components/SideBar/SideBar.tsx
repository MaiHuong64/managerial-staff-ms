...
import {DashboardOutlined, TeamOutlined,  FileTextOutlined, ApartmentOutlined, TagsOutlined, BarChartOutlined, PlusOutlined, StarOutlined, AccountBookOutlined
...
export const NAV_ITEMS: NavItem[] = [
    ...
    { icon:<AccountBookOutlined />, label: "Quản lý tài khoản", path: '/tai-khoan', roles: ['ADMIN']}
];
